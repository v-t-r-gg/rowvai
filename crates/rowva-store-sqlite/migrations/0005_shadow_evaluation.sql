CREATE TABLE _rowva_evaluation_cases (
 ...
 target_object_id TEXT NOT NULL, target_record_id TEXT NOT NULL, target_stage_field_id TEXT NOT NULL,
...
CREATE TABLE _rowva_evaluation_candidates (
 ...
 actor_id TEXT NOT NULL REFERENCES _rowva_actors(id), actor_version TEXT NOT NULL, actor_json TEXT NOT NULL, decision_json TEXT NOT NULL, reason TEXT, confidence REAL,
 fingerprint TEXT NOT NULL, submitted_at TEXT NOT NULL, validation_status TEXT NOT NULL, validation_error_json TEXT,
 eligible_for_metrics INTEGER NOT NULL, attempt_number INTEGER NOT NULL, eligibility_reason TEXT NOT NULL,
 supersedes_candidate_id TEXT REFERENCES _rowva_evaluation_candidates(id), normalized_changes_json TEXT NOT NULL,
 UNIQUE(case_id,actor_id,actor_version,attempt_number)
);
...
CREATE INDEX _rowva_eval_candidates_report ON _rowva_evaluation_candidates(workflow_version,actor_id,actor_version,submitted_at);
CREATE UNIQUE INDEX _rowva_eval_one_eligible_attempt ON _rowva_evaluation_candidates(case_id,actor_id,actor_version) WHERE eligible_for_metrics=1;
